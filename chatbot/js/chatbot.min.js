    ...
    setTimeout(function () {
      ...
      if (p.start < p.currentInput.length) {
        ...
        setTimeout(function () {
          ...
          p.conversationArrayIndex =
            p.conversationArrayIndex % p.conversationArray.length;
        ...
        q.css("left", s + "px");
        q.css("top", r + "px");
        q.animate({ width: $(g).outerWidth() + "px" }, o, function () {
          q.css("width", "0");
        });
      }
    }, Math.random() * 120 + 10);
                ...
                if (v.media != undefined) {
                  ...
                  for (var t = 0; t < v.media.length; t++) {
                    ...
                    u +=
                      ...
                      '" /><div class="title">' +
                      s.title +
                      '</div><div class="actions"><div class="button blue" onclick="document.location.href=\'' +
                      s.link +
                      '\'">Details</div><br><div class="button blue" onclick=" ChatBot.addChatEntry(\'more like number ' +
                      (t + 1) +
                      "','human');ChatBot.react('more like " +
                      (t + 1) +
                      "');\">More like this</div></div></div>";
                  }
                }
